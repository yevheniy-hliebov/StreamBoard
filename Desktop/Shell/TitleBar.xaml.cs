...
public partial class TitleBar : UserControl
{
    ...
    public static readonly DependencyProperty ShowAppIconProperty =
        DependencyProperty.Register(nameof(ShowAppIcon), typeof(bool), typeof(TitleBar), new PropertyMetadata(true));
    ...
    public static readonly DependencyProperty TitleProperty =
        DependencyProperty.Register(nameof(Title), typeof(string), typeof(TitleBar), new PropertyMetadata("StreamTabula"));
    ...
    public static readonly DependencyProperty SubtitleProperty =
        DependencyProperty.Register(nameof(Subtitle), typeof(string), typeof(TitleBar), new PropertyMetadata(null));
    ...
    public static readonly DependencyProperty RightContentProperty =
        DependencyProperty.Register(nameof(RightContent), typeof(object), typeof(TitleBar), new PropertyMetadata(null));
    ...
    public static readonly DependencyProperty ShowMaximizeProperty =
        DependencyProperty.Register(nameof(ShowMaximize), typeof(bool), typeof(TitleBar), new PropertyMetadata(true));
}